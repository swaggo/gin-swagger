...
### Upgrading Swagger UI files

To update the Swagger UI version, copy the contents of the
[swagger-api/swagger-ui](https://github.com/swagger-api/swagger-ui)
[dist folder](https://github.com/swagger-api/swagger-ui/tree/master/dist) into the `swaggerFiles/dist` folder here. This
will automatically be bundled into the gin-swagger package at build time.
